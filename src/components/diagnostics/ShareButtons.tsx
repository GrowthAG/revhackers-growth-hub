...
export const ShareButtons = ({ score, type, className = '' }: ShareButtonsProps) => {
 ...
 className="inline-flex items-center gap-2 px-4 py-2.5 bg-white text-zinc-900 hover:bg-zinc-50 text-xs font-bold transition-colors"
 >
 ...
 <button
 onClick={handlePrint}
 className="inline-flex items-center gap-2 px-4 py-2.5 border border-zinc-200 text-zinc-700 hover:bg-zinc-50 text-xs font-bold transition-colors"
 >
