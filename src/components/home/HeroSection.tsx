  ...
  return (
    ...
    >
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 flex flex-col items-center text-center">
        ...
        {/* Partner logos — alinhamento milimétrico */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={inView ? { opacity: 1 } : {}}
        ...
        >
          ...
          <div className="h-6 flex items-center">
            <img
              ...
              className="h-5 sm:h-5.5 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity"
            />
          </div>
          ...
          {/* Google for Startups */}
          <div className="h-6 flex items-center gap-1.5 opacity-70 hover:opacity-100 transition-opacity select-none">
            ...
            <span className="text-white text-xs font-semibold tracking-tight whitespace-nowrap">Google for Startups</span>
          </div>
