      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">
            Aumente sua <span className="text-revgreen">receita recorrente</span> com integração total entre Marketing, <br className="hidden md:block" />Vendas e CS
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Button 
              variant="outline" 
              asChild
              className="border-revgreen text-white hover:bg-revgreen hover:text-black min-w-[250px] py-6 px-8"
              size="lg"
            >
