        ...
        >
          ...
          <div className="h-7 flex items-center">
            <img
              ...
              className="h-5 w-auto object-contain opacity-75 hover:opacity-100 transition-opacity block"
            />
          </div>
          ...
          {/* Google for Startups */}
          <div className="h-7 flex items-center gap-2 opacity-75 hover:opacity-100 transition-opacity select-none">
