          ...
          <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12">
            ...
            <a href="https://anthropic.com" target="_blank" rel="noopener noreferrer" className="group">
              <img
                ...
                className="h-5 opacity-40 group-hover:opacity-70 transition-opacity invert"
              />
            </a>
            ...
            {/* Google for Startups */}
            <a href="https://startup.google.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 opacity-40 hover:opacity-70 transition-opacity group">
              ...
              <span className="text-zinc-400 text-xs font-medium tracking-wide group-hover:text-zinc-300">Google for Startups</span>
            </a>

            <div className="w-px h-4 bg-zinc-800 hidden sm:block" />

            {/* Funnels */}
            <a href="https://usefunnels.io" target="_blank" rel="noopener noreferrer" className="group">
              <img
                src="/brand/funnels-logo-white.png"
                alt="Funnels Partner"
                className="h-5 opacity-40 group-hover:opacity-70 transition-opacity"
              />
            </a>
          </div>
        </div>
