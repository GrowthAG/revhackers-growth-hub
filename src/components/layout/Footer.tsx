    ...
    <footer className="bg-black text-white pt-24 pb-12 border-t border-white/5">
      <div className="container-custom">
        ...
        <div className="mt-16 pt-8 border-t border-zinc-900">
          <p className="text-zinc-600 text-[0.65rem] uppercase tracking-[0.2em] font-semibold text-center mb-6">
            Technology Partners
          </p>
          <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12">
            ...
            {/* Google */}
            <a href="https://cloud.google.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-zinc-500 hover:text-zinc-300 transition-colors group">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 01-2.2 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
                <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l3.66-2.84z"/>
                <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
              </svg>
              <span className="text-xs font-semibold tracking-wide">Google Partner</span>
            </a>

            <div className="w-px h-4 bg-zinc-800 hidden sm:block" />

            {/* Funnels */}
            <a href="https://usefunnels.io" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-zinc-500 hover:text-zinc-300 transition-colors group">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M3 4h18a1 1 0 011 1v2a1 1 0 01-.293.707L15 14.414V20a1 1 0 01-.553.894l-4 2A1 1 0 019 22v-7.586L2.293 7.707A1 1 0 012 7V5a1 1 0 011-1z"/>
              </svg>
              <span className="text-xs font-semibold tracking-wide">Funnels Partner</span>
            </a>
          </div>
        </div>
