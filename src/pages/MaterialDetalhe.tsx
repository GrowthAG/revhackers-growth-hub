    ...
    <PageLayout>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom max-w-4xl">
          ...
          {showForm && (
            <div id="download-form" className="mt-16 mx-auto bg-white rounded-xl shadow-xl p-6 md:p-8 border">
              <h2 className="text-2xl font-bold mb-6">
                Preencha seus dados para baixar "{cleanHtml(title)}"
              </h2>
              <DownloadForm 
                materialId={material.materialId} 
                materialType={material.type || 'Material'}
                linkMaterial={material.link_material}
