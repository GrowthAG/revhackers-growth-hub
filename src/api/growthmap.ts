...
export const FRAMEWORK_CATALOG = [
  ...
  { id: 'industry_insights',   pillar: 'inteligencia_estrategica' as const, title: 'Industry Insights',         subtitle: 'Panorama do setor, vetores de crescimento e desafios' },
  { id: 'vrio_interna',        pillar: 'inteligencia_estrategica' as const, title: 'Análise VRIO Interna',      subtitle: 'Diagnóstico interno de recursos e capacidades' },
  { id: 'blue_ocean',          pillar: 'inteligencia_estrategica' as const, title: 'Blue Ocean Strategy',       subtitle: 'Criar novos espaços de mercado sem concorrência' },
  { id: 'ansoff_matrix',       pillar: 'inteligencia_estrategica' as const, title: 'Matriz de Ansoff',          subtitle: '4 estratégias de crescimento: penetração, mercado, produto, diversificação' },
  ...
  { id: 'business_model_canvas', pillar: 'concepcao_valor' as const, title: 'Business Model Canvas',      subtitle: 'Modelo de negócio enxuto em 9 blocos' },
  { id: 'catwoe',               pillar: 'concepcao_valor' as const, title: 'CATWOE Analysis',           subtitle: 'Customers, Actors, Transformation, World view, Owner, Environment' },
  { id: 'personas_detalhadas',  pillar: 'concepcao_valor' as const, title: 'Personas Detalhadas',        subtitle: 'Perfis semi-fictícios com objetivos e frustrações' },
  { id: 'jobs_to_be_done',      pillar: 'concepcao_valor' as const, title: 'Jobs To Be Done',           subtitle: 'O trabalho que o cliente contrata seu produto para fazer' },
  { id: 'game_changing_idea',   pillar: 'concepcao_valor' as const, title: 'Game Changing Idea',        subtitle: 'Ideia que muda as regras do mercado' },
  ...
  { id: 'caminho_mvp',          pillar: 'mvp_validacao' as const, title: 'Caminho para MVP',           subtitle: 'Roadmap de validação do conceito ao MVP' },
  { id: 'mvp_definition',       pillar: 'mvp_validacao' as const, title: 'Minimum Viable Product',     subtitle: 'Definição e escopo do MVP' },
  { id: 'ux_heuristics',        pillar: 'mvp_validacao' as const, title: 'Análise Heurística UX',      subtitle: '10 heurísticas de Nielsen para usabilidade' },
  { id: 'innovation_accounting', pillar: 'mvp_validacao' as const, title: 'Innovation Accounting',     subtitle: 'Métricas de inovação e aprendizado' },
  ...
  { id: 'marketing_branding',   pillar: 'escalabilidade' as const, title: 'Marketing e Branding',      subtitle: 'Estratégia de marca e aquisição' },
  { id: 'growth_loops',         pillar: 'escalabilidade' as const, title: 'Growth Loops',              subtitle: 'Loops virais e de retenção para crescimento sustentável' },
  { id: 'partner_program',      pillar: 'escalabilidade' as const, title: 'Programa de Parceiros',     subtitle: 'Estratégia de canais via parceiros' },
  { id: 'game_changing_scaling', pillar: 'escalabilidade' as const, title: 'Game Changing Scaling',    subtitle: 'Scaling exponencial através de mudanças de modelo' },
  { id: 'horizon_1_2_3',        pillar: 'escalabilidade' as const, title: 'Horizon 1-2-3 (McKinsey)',  subtitle: 'Gestão de portfólio de inovação por horizonte' },
  { id: 'performance_metrics',  pillar: 'escalabilidade' as const, title: 'Performance Metrics',       subtitle: 'KPIs de performance por canal' },
  { id: 'estrategia_financeira', pillar: 'escalabilidade' as const, title: 'Estratégia Financeira',     subtitle: 'Planejamento financeiro e unit economics' },
  { id: 'squadmatch',           pillar: 'escalabilidade' as const, title: 'SquadMatch',                subtitle: 'Montagem de squads especializados sob demanda' },
  { id: 'execution_loop',       pillar: 'escalabilidade' as const, title: 'ExecutionLoop',            subtitle: 'Loop contínuo de execução e aprendizado' },
] as const;
