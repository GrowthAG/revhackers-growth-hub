...
function generatePageHtml() {
  ...
  for (const page of pages) {
    ...
    customHtml = customHtml.replace(/<meta property="og:image"\s+content="[^"]*"/gi, `<meta property="og:image" content="${page.image}"`);
    ...
    customHtml = customHtml.replace(/<meta name="twitter:image"\s+content="[^"]*"/gi, `<meta name="twitter:image" content="${page.image}"`);
